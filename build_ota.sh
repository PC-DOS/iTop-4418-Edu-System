...
function build_dist()
{
	...
	cp -r out/target/product/${BOARD_NAME}/boot ${RESULT_DIR}/
	cp -r out/target/product/${BOARD_NAME}/root ${RESULT_DIR}/
	...
	build/tools/releasetools/ota_from_target_files -v -p out/host/linux-x86 ${RESULT_DIR}/target.zip ${RESULT_DIR}/${ota_name}
	...
	cp ${RESULT_DIR}/${ota_name} ${RESULT_DIR}/ota.zip
