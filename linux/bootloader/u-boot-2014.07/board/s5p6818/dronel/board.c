...
int cfg_disp_pri_pixel_clock = (780000000/12);//800000000/12;
...
#if 1
	p = getenv("bootargs");
	if((p == NULL) || (strstr(p, "console=ttySAC0,115200n8 androidboot.hardware=s5p6818_drone androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=9.7"))
			|| (strstr(p, "console=ttySAC0,115200n8 androidboot.hardware=s5p6818_drone androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=5.0"))
			|| (strstr(p, "console=ttySAC0,115200n8 androidboot.hardware=s5p6818_drone androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=7.0"))
			|| (strstr(p, "console=ttySAC0,115200n8 androidboot.hardware=s5p6818_drone androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=4.3"))
			|| (strstr(p, "console=ttySAC0,115200n8 androidboot.hardware=s5p6818_drone androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=1024x600"))
			|| (strstr(p, "console=ttySAC0,115200n8 androidboot.hardware=s5p6818_drone androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=hdmi"))
			|| (strstr(p, "console=ttySAC0,115200n8 androidboot.hardware=drone2 androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=9.7"))
			|| (strstr(p, "console=ttySAC0,115200n8 androidboot.hardware=drone2 androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=5.0"))
                        || (strstr(p, "console=ttySAC0,115200n8 androidboot.hardware=drone2 androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=7.0"))
                        || (strstr(p, "console=ttySAC0,115200n8 androidboot.hardware=drone2 androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=4.3"))
                        || (strstr(p, "console=ttySAC0,115200n8 androidboot.hardware=drone2 androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=1024x600"))
                        || (strstr(p, "console=ttySAC0,115200n8 androidboot.hardware=drone2 androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=hdmi"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk1p2 init=/linuxrc rootfstype=ext4 lcdtype=9.7 rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk1p2 init=/linuxrc rootfstype=ext4 lcdtype=5.0 rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk1p2 init=/linuxrc rootfstype=ext4 lcdtype=7.0 rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk1p2 init=/linuxrc rootfstype=ext4 lcdtype=4.3 rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk1p2 init=/linuxrc rootfstype=ext4 lcdtype=1024x600 rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk1p2 init=/linuxrc rootfstype=ext4 lcdtype=hdmi rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p2 init=/linuxrc rootfstype=ext4 lcdtype=9.7 rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p2 init=/linuxrc rootfstype=ext4 lcdtype=5.0 rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p2 init=/linuxrc rootfstype=ext4 lcdtype=7.0 rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p2 init=/linuxrc rootfstype=ext4 lcdtype=4.3 rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p2 init=/linuxrc rootfstype=ext4 lcdtype=1024x600 rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p2 init=/linuxrc rootfstype=ext4 lcdtype=hdmi rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p1 init=/linuxrc rootfstype=ext4 lcdtype=9.7 bootsystem=ubuntu_tf rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p1 init=/linuxrc rootfstype=ext4 lcdtype=5.0 bootsystem=ubuntu_tf rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p1 init=/linuxrc rootfstype=ext4 lcdtype=7.0 bootsystem=ubuntu_tf rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p1 init=/linuxrc rootfstype=ext4 lcdtype=4.3 bootsystem=ubuntu_tf rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p1 init=/linuxrc rootfstype=ext4 lcdtype=1024x600 bootsystem=ubuntu_tf rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p1 init=/linuxrc rootfstype=ext4 lcdtype=hdmi bootsystem=ubuntu_tf rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk1p7 init=/linuxrc rootfstype=ext4 lcdtype=9.7 bootsystem=ubuntu_emmc rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk1p7 init=/linuxrc rootfstype=ext4 lcdtype=5.0 bootsystem=ubuntu_emmc rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk1p7 init=/linuxrc rootfstype=ext4 lcdtype=7.0 bootsystem=ubuntu_emmc rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk1p7 init=/linuxrc rootfstype=ext4 lcdtype=4.3 bootsystem=ubuntu_emmc rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk1p7 init=/linuxrc rootfstype=ext4 lcdtype=1024x600 bootsystem=ubuntu_emmc rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk1p7 init=/linuxrc rootfstype=ext4 lcdtype=hdmi bootsystem=ubuntu_emmc rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p7 init=/linuxrc rootfstype=ext4 lcdtype=9.7 bootsystem=ubuntu_emmc rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p7 init=/linuxrc rootfstype=ext4 lcdtype=5.0 bootsystem=ubuntu_emmc rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p7 init=/linuxrc rootfstype=ext4 lcdtype=7.0 bootsystem=ubuntu_emmc rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p7 init=/linuxrc rootfstype=ext4 lcdtype=4.3 bootsystem=ubuntu_emmc rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p7 init=/linuxrc rootfstype=ext4 lcdtype=1024x600 bootsystem=ubuntu_emmc rootwait"))
			|| (strstr(p, "console=ttySAC0,115200 root=/dev/mmcblk0p7 init=/linuxrc rootfstype=ext4 lcdtype=hdmi bootsystem=ubuntu_emmc rootwait")))
	{
#endif
		/* end add */
		...
		if(!strcmp(p, "9.7"))
			...
			;
		...
		else if(!strcmp(p, "1024x600"))
                {
                        ...
                        cfg_disp_pri_clkgen0_div = 15;//13;//12; // even divide;
                        //cfg_disp_pri_clkgen1_div = 2;//1;
                }
		...
		if(0 == boot_system_flags)
			...
			if(4 == android_version)
                        {
				sprintf(bootargs, "console=ttySAC0,115200n8 androidboot.hardware=drone2 androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=%s", p);
			}
			else if(5 == android_version)
			{
                        	sprintf(bootargs, "console=ttySAC0,115200n8 androidboot.hardware=s5p6818_drone androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=%s", p);
			}
                ...
                {
			if(!tf_insert_flags)
                        	sprintf(bootargs, "console=ttySAC0,115200 root=/dev/mmcblk0p2 init=/linuxrc rootfstype=ext4 lcdtype=%s rootwait", p);
			else
				sprintf(bootargs, "console=ttySAC0,115200 root=/dev/mmcblk1p2 init=/linuxrc rootfstype=ext4 lcdtype=%s rootwait", p);

                        setenv("bootcmd", "ext4load mmc 2:1 0x48000000 uImage;bootm 0x48000000");
                }
		else if(2 == boot_system_flags)//Ubuntu TF
                {
                        sprintf(bootargs, "console=ttySAC0,115200 root=/dev/mmcblk0p1 init=/linuxrc rootfstype=ext4 lcdtype=%s bootsystem=%s rootwait", p, getenv("bootsystem"));
                ...
                {
			if(!tf_insert_flags)
                        	sprintf(bootargs, "console=ttySAC0,115200 root=/dev/mmcblk0p7 init=/linuxrc rootfstype=ext4 lcdtype=%s bootsystem=%s rootwait", p, getenv("bootsystem"));
			else
				sprintf(bootargs, "console=ttySAC0,115200 root=/dev/mmcblk1p7 init=/linuxrc rootfstype=ext4 lcdtype=%s bootsystem=%s rootwait", p, getenv("bootsystem"));

                        setenv("bootcmd", "ext4load mmc 2:1 0x48000000 uImage;bootm 0x48000000");
                }
                else
                {
                        sprintf(bootargs, "console=ttySAC0,115200n8 androidboot.hardware=s5p6818_drone androidboot.console=ttyAMA0 androidboot.serialno=0123456789abcdef initrd=0x49000000,0x1000000 init=/init lcdtype=%s", p);
