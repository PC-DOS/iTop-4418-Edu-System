...
#else
#define CONFIG_SYS_PROMPT               "iTOP-6818# "
#endif
/* end modify */
...
#define CONFIG_PMIC
		...
		#define CFG_IO_I2C3_SCL ((PAD_GPIO_C + 15) | PAD_FUNC_ALT1)
        	#define CFG_IO_I2C3_SDA ((PAD_GPIO_C + 16) | PAD_FUNC_ALT1)
...
#define CONFIG_ENV_IS_IN_MMC
	...
	#define CONFIG_MMC2_BUS_WIDTH       4//8
...
#define FASTBOOT_PARTS_DEFAULT_5_1	\
                        "flash=mmc,2:uboot:2nd:0x200,0x78000;" \
                        "flash=mmc,2:2ndboot:2nd:0x200,0x4000;" \
                        "flash=mmc,2:bootloader:boot:0x8000,0x70000;"   \
                        "flash=mmc,2:boot:ext4:0x00100000,0x04000000;"          \
...
//	#define CONFIG_CMD_LOGO_LOAD
	...
	/* From NAND */
    /* add by cym 20161108 for logo display in 7 inch screen */
    #define CONFIG_CMD_LOGO_800_1280 "ext4load mmc 2:1 0x47000000 logo_800_1280.bmp; drawbmp 0x47000000"
    /* end add */
...
/* add by cym 20151127 */
    #define CONFIG_DISPLAY_LCD_TYPE "9.7"
/* end add */

/* add by cym 20160107 */
    #define CONFIG_BOOT_SYSTEM "android"
/* end add */

/* add by cym 20160830 */
    #define CONFIG_ANDROID_VERSION "5.1"
/* end add */
