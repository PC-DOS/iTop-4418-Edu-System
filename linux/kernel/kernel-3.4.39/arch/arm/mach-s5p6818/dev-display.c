...
/* add by cym 20170810 */
        ...
        else if(!strncasecmp("1024x600", str, 8))
        {
                ...
                __lcd_vsync.clk_div_lv0 = 15;//13;//24;
                //__lcd_vsync.clk_div_lv1 = 2;
#endif
#endif
                ...
                __lvds_vsync.clk_div_lv0 = 15;//13;//24;
                //__lvds_vsync.clk_div_lv1 = 2;
#endif
#endif
                 ...
                 __mipi_vsync.clk_div_lv0 = 15;//13;//24;
                 //__mipi_vsync.clk_div_lv1 = 2;
#endif
#endif
        }
