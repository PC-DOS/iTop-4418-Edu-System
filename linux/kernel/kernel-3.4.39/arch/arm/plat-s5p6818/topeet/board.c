...
/* add by cym 20180522 */
unsigned char gpioa_strength = 0;

static int __init setup_width_height_param(char *str)
{
	if (!strncasecmp("4.3", str, 3))
	{
		gpioa_strength = 0;
		//printk("***************************000:fun:%s, line = %d\n", __FUNCTION__, __LINE__);
	}
	else
	{
		gpioa_strength = 2;
...
static void bd_gpio_init(void)
{
	...
	if(2 == gpioa_strength)
	{
	   pads[0][1]=PAD_GPIOA1_2; pads[0][2]=PAD_GPIOA2_2; pads[0][3]=PAD_GPIOA3_2; pads[0][4]=PAD_GPIOA4_2;
	   pads[0][5]=PAD_GPIOA5_2; pads[0][6]=PAD_GPIOA6_2; pads[0][7]=PAD_GPIOA7_2; pads[0][8]=PAD_GPIOA8_2;
	   pads[0][9]=PAD_GPIOA9_2; pads[0][10]=PAD_GPIOA10_2; pads[0][11]=PAD_GPIOA11_2; pads[0][12]=PAD_GPIOA12_2;
	   pads[0][13]=PAD_GPIOA13_2; pads[0][14]=PAD_GPIOA14_2; pads[0][15]=PAD_GPIOA15_2; pads[0][16]=PAD_GPIOA16_2;
	   pads[0][17]=PAD_GPIOA17_2; pads[0][18]=PAD_GPIOA18_2; pads[0][19]=PAD_GPIOA19_2; pads[0][20]=PAD_GPIOA20_2;
	   pads[0][21]=PAD_GPIOA21_2; pads[0][22]=PAD_GPIOA22_2; pads[0][23]=PAD_GPIOA23_2;
	   pads[0][24]=PAD_GPIOA24_2; pads[0][25]=PAD_GPIOA25_2; pads[0][26]=PAD_GPIOA26_2; pads[0][27]=PAD_GPIOA27_2;
	}
	/* end add */
