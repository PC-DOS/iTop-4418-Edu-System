...
static struct i2c_board_info at24_i2c_bdi __initdata = {
	.type = "24c08",
	.addr = 0x50,
...
{//TVP5150
   ...
   .parallel = {
       .is_mipi        = false,
       .external_sync  = false,
       .h_active       = 704,//640,//1280,//1920,640
       .h_frontporch   = 0,
       .h_syncwidth    = 0,
       .h_backporch    = 2,
       .v_active       = 240,//480,//960,//1080,480
       .v_frontporch   = 0,
       .v_syncwidth    = 0,
       .v_backporch    = 2,//13,
       .clock_invert   = false,
...
#if defined(CONFIG_EEPROM_AT24) || defined(CONFIG_EEPROM_AT24_MODULE)
	printk("plat: add EEPROM AT24\n");
        i2c_register_board_info(2, &at24_i2c_bdi, 1);
#endif
