...
#define GTP_RST_PORT    (PAD_GPIO_E + 30)//IMX_GPIO_NR(6, 16)//IMX_GPIO_TO_PIN(6, 7)
#define GTP_INT_PORT    (PAD_GPIO_B + 29)//IMX_GPIO_NR(6, 7)//IMX_GPIO_TO_PIN(4, 20)
...
#define GTP_GPIO_GET_VALUE(pin)         nxp_soc_gpio_get_in_value(pin)
#define GTP_GPIO_OUTPUT(pin,level)      nxp_soc_gpio_set_out_value(pin,level)
