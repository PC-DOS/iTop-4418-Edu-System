...
/* modify by cym 20170815 for rescan phy device */
#if 0
...
#else
	for(phy_addr=1; phy_addr<8; phy_addr++)
	{
		snprintf(phy_id_fmt, MII_BUS_ID_SIZE + 3, PHY_ID_FMT, bus_id, phy_addr);
		pr_debug("stmmac_init_phy:  trying to attach to %s\n", phy_id_fmt);
