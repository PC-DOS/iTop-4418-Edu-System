# iTop-4418内核及uBoot源代码修改日志：配置Qt/E 4.8.7
...
开发计算机操作系统为Windows Server 2012 R2 x64，在VMware Workstation Pro 15.5中运行64位Ubuntu 12.04.5 LTS系统。Ubuntu登录用户名为`picsell-dois`。
